...
<!--左侧的的菜单的信息 -->
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/bootstrap/images/img.jpg" alt="">金亮
  ...
  <!-- gauge js -->
  <script type="text/javascript" src="assets/bootstrap/js/gauge/gauge.min.js"></script>
  <script type="text/javascript" src="assets/bootstrap/js/gauge/gauge_demo.js"></script>
  ...
  <!-- daterangepicker -->
  <script type="text/javascript" src="assets/bootstrap/js/moment/moment.min.js"></script>
  ...
  <!-- worldmap -->
  <script type="text/javascript" src="assets/bootstrap/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
